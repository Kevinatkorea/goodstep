# CLAUDE.md — Good Step 브랜드 웹사이트

## 프로젝트 개요
- Good Step 브랜드 홈페이지 (정적 웹사이트)
- 주요 파일: `index.html`, `css/style.css`, `js/main.js`
- 이미지: `images/` 디렉토리
- 참고 자료: `참고데이터/` 디렉토리
...
7. **메모리 관리:** 컨텍스트 기억을 위해 지속적으로 memory 업데이트
...
## playwright MCP 세팅
- Playwright MCP를 통한 브라우저 테스트 및 검증 가능
- 변경사항 검증 시 실제 브라우저에서 스크린샷/스냅샷 확인 활용

## 기술 스택 & 컨벤션
- 순수 HTML/CSS/JS (프레임워크 없음)
- 모바일 반응형 디자인 (iOS 최적화 포함)
- 이미지 슬라이더, 리뷰 캐러셀 등 인터랙티브 요소
- 메뉴/푸터 라벨은 영문 사용
